                                ...
                                <tr>
                                    <td>
                                        <table role="presentation" style="margin: 0 auto;">
                                            <tr>
                                                <td style="padding: 0;">
                                                    <table role="presentation" width="40" height="40" style="border-collapse: separate; border-spacing: 0; width: 40px; height: 40px; background: linear-gradient(135deg, #1976d2 0%, #1565c0 100%); border-radius: 10px;">
                                                        <tr>
                                                            <td align="center" valign="middle" width="40" height="40" style="width: 40px; height: 40px; color: #ffffff; font-size: 20px; font-weight: 600; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 40px; mso-line-height-rule: exactly; text-align: center;">
                                                                W
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td style="padding: 0 0 0 12px;">
                                                    <a href="https://wohoo.ai" style="margin: 0; display: inline-block; font-size: 32px; font-weight: 600; color: #1976d2; background: linear-gradient(135deg, #1976d2 0%, #1565c0 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; letter-spacing: -0.02em; text-decoration: none; line-height: 1.2;">
                                                        wohoo.ai
                                                    </a>
                                                </td>
                                            </tr>
